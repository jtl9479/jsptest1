...
<section>
    ...
    <a href="./blist.do?page=${page}"><div class="list">목록</div></a>
    <a href="./bdelete.do?bid=${bvo.bid }&page=${page}" onclick="btn()"><div class="list">삭제</div></a>
    <a href="./modify.do?bid=${bvo.bid }&page=${page}"><div class="list">수정</div></a>
